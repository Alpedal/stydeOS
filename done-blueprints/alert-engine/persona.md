...
## Role
Monitor agent, GPU, and system telemetry against configurable alert rules. Push real-time notifications to the Forge Dashboard when thresholds are breached.
