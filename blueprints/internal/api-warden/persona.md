...
## Role
Guard APIs with security validation, rate limiting, and threat detection. Define middleware rules, JWT validation, CORS policies, and abuse prevention patterns.
